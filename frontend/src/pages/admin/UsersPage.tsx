                ...
                <thead>
                  <tr className="border-b border-dark-800">
                    <th className="text-left px-6 py-3.5">
                      <button onClick={() => toggleSort('displayName')} className="flex items-center gap-1.5 text-sm font-medium text-dark-400 hover:text-dark-50 transition-colors">
                        User
                  ...
                  {users.map((user) => (
                    ...
                    >
                      <td className="px-6 py-3.5">
                        <p className="text-sm font-medium text-dark-50">{user.displayName}</p>
